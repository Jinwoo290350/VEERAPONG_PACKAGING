...
export default function FloatingLine() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-24 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#06C755] text-white shadow-lg shadow-navy-950/20 transition hover:scale-105"
    >
